<?php
$stukramorder_options = get_option('stukramorder_options');
$stukramorder_objects = isset($stukramorder_options['objects']) ? $stukramorder_options['objects'] : array();
$stukramorder_tags = isset($stukramorder_options['tags']) ? $stukramorder_options['tags'] : array();

$advanced_view = isset($stukramorder_options['show_advanced_view']) ? $stukramorder_options['show_advanced_view'] : '';
?>
<style>
...
<div class="wrap">
    <h2><?php _e('stukram Post Order Settings', 'restabook-plugin'); ?></h2>
    ...
    <form method="post">
        ...
        <?php if (function_exists('wp_nonce_field')) wp_nonce_field('nonce_stukramorder'); ?>

        <div id="stukramorder_select_objects">
                        ...
                        <td>
                            <label>
                                <div class="epsilon-toggle">
                                    <input id="stukramorder_allcheck_objects" class="epsilon-toggle__input" type="checkbox">
                            ...
                            <?php
                            $post_types_args = apply_filters('STUKRAM_order_post_types_args', array(
                                'show_ui'      => true,
                                'show_in_menu' => true,
                            ),$stukramorder_options);
                            ...
                            foreach ($post_types as $post_type) {
                                ...
                                <label>
                                    <div class="epsilon-toggle">
                                        ...
                                        if (isset($stukramorder_objects) && is_array($stukramorder_objects)) {
	                                        if (in_array($post_type->name, $stukramorder_objects)) {
        ...
        <div id="stukramorder_select_tags">
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        ...
                        <td>
                            <label>
                                <div class="epsilon-toggle">
                                    <input id="stukramorder_allcheck_tags" class="epsilon-toggle__input" type="checkbox">
                                    <div class="epsilon-toggle__items">
                                        <span class="epsilon-toggle__track"></span>
                                        <span class="epsilon-toggle__thumb"></span>
                                        <svg class="epsilon-toggle__off" width="6" height="6" aria-hidden="true"
                            ...
                            foreach ($taxonomies as $taxonomy) {
                                ...
                                <label>
                                    <div class="epsilon-toggle">
                                        ...
                                        if (isset($stukramorder_tags) && is_array($stukramorder_tags)) {
	                                        if (in_array($taxonomy->name, $stukramorder_tags)) {
		                                        echo 'checked="checked"';
	                                        }
                                        }
                                        ?>>
        ...
        <div id="stukramorder_advanved_view">
            <table class="form-table">
                <tbody>
                <tr valign="top">
        ...
        <p class="submit">
            <input type="submit" class="button-primary" name="stukramorder_submit" value="<?php _e('Update', 'restabook-plugin'); ?>">
        </p>

    </form>
    <div class="scpo-reset-order">
        <h1>Want to reset the order of the posts?</h1>
        <div id="STUKRAM_order_reset_select_objects">
            <table class="form-table">
                <tbody>
                <tr valign="top">
...
<script>
    (function ($) {
        ...
        $("#stukramorder_allcheck_objects").on('click', function () {
            var items = $("#stukramorder_select_objects input");
            if ($(this).is(':checked'))
        ...
        $("#stukramorder_allcheck_tags").on('click', function () {
            var items = $("#stukramorder_select_tags input");
            if ($(this).is(':checked'))
                $(items).prop('checked', true);
            else
                $(items).prop('checked', false);
        ...
        $('#reset-scp-order').click(function (e) {
            ...
            var btn = $(this),
                ...
                items = [],
                data = {
                    action: 'STUKRAM_order_reset_order',
                    STUKRAM_order_security: '<?php echo wp_create_nonce("scpo-reset-order"); ?>'
                };
