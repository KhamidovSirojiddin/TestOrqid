<?php $stukram_options = get_option('stukram'); ?>
	...
	<?php } ;?>	  
      <header class="header <?php echo esc_attr($stukram_header_logo_color);?> -sticky<?php echo esc_attr($stukram_header_color);?> js-header<?php echo esc_attr($stukram_header_color);?> js-header">
        <!-- header__bar start -->
        <div class="header__bar">
          ...
          <div class="header__menu js-header-menu">
            <button type="button" class="nav-button-open js-nav-open">
              ...
              <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="107" height="88" viewBox="0 0 127 92">
                  <image width="107" height="88" xlink:href="data:image/png;base64,"></image>
                </svg>
            </button>
          </div>
        </div>
                  ...
                  <div class="nav__info">
                    ...
                    <div class="nav__info__item js-navInfo-item">
                      ...
                      <?php if(!empty($stukram_options['hd_address1'])):?>
						<?php if (Stukram_AfterSetupTheme::return_thme_option('hd_address_link_target')=='st2'){ ?>  
							<?php $stukram_header_address_link_target = '_blank';?>		
						<?php } else { ?> 
							<?php $stukram_header_address_link_target = '_self';?>
						<?php } ;?>						  
                      <div class="nav__info__content text-lg text-white mt-16">
					    <p>	
							<?php if(!empty($stukram_options['hd_address1_link_url'])):?>
							  <a href="<?php echo esc_url($stukram_options['hd_address1_link_url']);?>" target="<?php echo esc_attr($stukram_header_address_link_target);?>"><?php echo esc_html(Stukram_AfterSetupTheme::return_thme_option('hd_address1',''));?></a>
							<?php else : ?> 						
						       <?php echo Stukram_AfterSetupTheme::return_thme_option('hd_address1','');?>
							<?php endif;?>
						</p>
						<?php if(!empty($stukram_options['hd_address2'])):?>
						    <p>
								<?php if(!empty($stukram_options['hd_address2_link_url'])):?>
								  <a href="<?php echo esc_url($stukram_options['hd_address2_link_url']);?>" target="<?php echo esc_attr($stukram_header_address_link_target);?>"><?php echo esc_html(Stukram_AfterSetupTheme::return_thme_option('hd_address2',''));?></a>
								<?php else : ?> 						
								   <?php echo esc_html(Stukram_AfterSetupTheme::return_thme_option('hd_address2',''));?>
								<?php endif;?>							
							</p>
						<?php endif;?>					  
                      </div>
                    ...
                    <div class="nav__info__item js-navInfo-item">
                      ...
                      <div class="nav__info__content text-lg text-white mt-16">
                        ...
                        <a href="tel:<?php echo esc_attr(Stukram_AfterSetupTheme::return_thme_option('hd_phn_number1',''));?>"><?php echo esc_html(Stukram_AfterSetupTheme::return_thme_option('hd_phn_number1',''));?></a>
						<?php endif;?>
						<?php if(!empty($stukram_options['hd_phn_number2'])):?>
                        <a href="tel:<?php echo esc_attr(Stukram_AfterSetupTheme::return_thme_option('hd_phn_number2',''));?>"><?php echo esc_html(Stukram_AfterSetupTheme::return_thme_option('hd_phn_number2',''));?></a>
						<?php endif;?>
                      </div>
                    </div>
					<?php endif;?>
